 ...
 * @param {string} [options.fallbackNpmPath] -
 *   The path to use when npmPath option was not provided and process.env.npm_execpath is not available.
...
module.exports = function yarpm(argv, options) {
  return new Promise((resolve, reject) => {
    ...
    if (!options.npmPath || path.extname(options.npmPath) === '.js') {
      ...
      execPath = npmPath ? process.execPath : (options.fallbackNpmPath || 'npm');
